...
namespace Beerio.Tests
{
    ...
    public class RecipeTests
    {
        ...
        {
            var recipe = new Recipe() { Name = "foo" };
            recipe.AddRecipeIngredient(new Ingredient() { Name = "water" }, 1, Units.gal);
            recipe.AddRecipeIngredient(new Ingredient() { Name = "hops" }, 10, Units.cup);
            recipe.AddRecipeIngredient(new Ingredient() { Name = "yeast" }, 5, Units.oz);
