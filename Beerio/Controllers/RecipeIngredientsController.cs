...
namespace Beerio.Controllers
{
    public class RecipeIngredientsController : Controller
    {
        ...
        public RecipeIngredientsController(BeerioContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,RecipeID,IngredientID,Quantity,Unit")] RecipeIngredient recipeIngredient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,RecipeID,IngredientID,Quantity,Unit")] RecipeIngredient recipeIngredient)
        {
